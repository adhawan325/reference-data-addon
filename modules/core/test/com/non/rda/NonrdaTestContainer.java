...
public class NonrdaTestContainer extends TestContainer {

    public NonrdaTestContainer() {
        super();
    ...
    public static class Common extends NonrdaTestContainer {

        public static final NonrdaTestContainer.Common INSTANCE = new NonrdaTestContainer.Common();
